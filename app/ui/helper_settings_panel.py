...
except these toggles are not any single window's own: video is a
...
dialog both live on OverlayConfig already; and log animation is one flag
on the log_panel module that every window's LogPanel reads.
"""
